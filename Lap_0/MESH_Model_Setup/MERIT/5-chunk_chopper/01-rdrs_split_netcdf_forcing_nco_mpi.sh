...
#SBATCH --job-name=split_rdrs_netcdf
#SBATCH --output=split_rdrs_%A_%a.out
#SBATCH --error=split_rdrs_%A_%a.err
...
# Configuration
input_file="remapped_rdrs_forcing_1980_2018.nc"
chunk_size=520
total_subbasins=77017
output_dir="./subbasin_forcing_CaSRv2p1"
mkdir -p "$output_dir"
