...
The model uses 7 key climate forcing variables from the **Canadian Surface Reanalysis (CaSR v3.1)** dataset and forecast precipitation [(Keshavarz, 2024)](https://datatool.readthedocs.io/en/latest/datasets.html#summary):
